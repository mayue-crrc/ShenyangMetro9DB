...
void VehicleEBCUPage::updatePage()
{
    ...
    //常用制动施加
    setlabelstates(ui->BRKApplyTC1_1lbl,this->database->BR1CT_TC1Bg1AirBrkRlsed_B1,this->database->BR1CT_TC1Bg1AirBrkApplied_B1,this->database->CTHM_BCULBg1Online_B1);
    setlabelstates(ui->BRKApplyTC1_2lbl,this->database->BR1CT_TC1Bg2AirBrkRlsed_B1,this->database->BR1CT_TC1Bg2AirBrkApplied_B1,this->database->CTHM_BCULBg2Online_B1);
    setlabelstates(ui->BRKApplyTC2_1lbl,this->database->BR2CT_TC2Bg1AirBrkRlsed_B1,this->database->BR2CT_TC2Bg1AirBrkApplied_B1,this->database->CTHM_BCURBg1Online_B1);
    setlabelstates(ui->BRKApplyTC2_2lbl,this->database->BR2CT_TC2Bg2AirBrkRlsed_B1,this->database->BR2CT_TC2Bg2AirBrkApplied_B1,this->database->CTHM_BCURBg2Online_B1);
    setlabelstates(ui->BRKApplyMP1_1lbl,this->database->BR1CT_MP1Bg1AirBrkRlsed_B1,this->database->BR1CT_MP1Bg1AirBrkApplied_B1,this->database->CTHM_BCULBg3Online_B1);
    setlabelstates(ui->BRKApplyMP1_2lbl,this->database->BR1CT_MP1Bg2AirBrkRlsed_B1,this->database->BR1CT_MP1Bg2AirBrkApplied_B1,this->database->CTHM_BCULBg4Online_B1);
    setlabelstates(ui->BRKApplyMP2_1lbl,this->database->BR2CT_MP2Bg1AirBrkRlsed_B1,this->database->BR2CT_MP2Bg1AirBrkApplied_B1,this->database->CTHM_BCURBg3Online_B1);
    setlabelstates(ui->BRKApplyMP2_2lbl,this->database->BR2CT_MP2Bg2AirBrkRlsed_B1,this->database->BR2CT_MP2Bg2AirBrkApplied_B1,this->database->CTHM_BCURBg4Online_B1);
    setlabelstates(ui->BRKApplyM1_1lbl,this->database->BR1CT_M1Bg1AirBrkRlsed_B1,this->database->BR1CT_M1Bg1AirBrkApplied_B1,this->database->CTHM_BCULBg5Online_B1);
    setlabelstates(ui->BRKApplyM1_2lbl,this->database->BR1CT_M1Bg2AirBrkRlsed_B1,this->database->BR1CT_M1Bg2AirBrkApplied_B1,this->database->CTHM_BCULBg6Online_B1);
    setlabelstates(ui->BRKApplyM2_1lbl,this->database->BR2CT_M2Bg1AirBrkRlsed_B1,this->database->BR2CT_M2Bg1AirBrkApplied_B1,this->database->CTHM_BCURBg5Online_B1);
    setlabelstates(ui->BRKApplyM2_2lbl,this->database->BR2CT_M2Bg2AirBrkRlsed_B1,this->database->BR2CT_M2Bg2AirBrkApplied_B1,this->database->CTHM_BCURBg6Online_B1);
    ...
    //停放制动施加 绿色＝施加 灰色＝缓解
    setlabelstates(ui->StopBRKTC1lbl,!this->database->BR1CT_TC1Bg2ParkingBrkRlsed_B1,this->database->CTHM_BCULBg2Online_B1);
    setlabelstates(ui->StopBRKTC2lbl,!this->database->BR2CT_TC2Bg2ParkingBrkRlsed_B1,this->database->CTHM_BCURBg2Online_B1);
    setlabelstates(ui->StopBRKMP1lbl,!this->database->BR1CT_MP1Bg2ParkingBrkRlsed_B1,this->database->CTHM_BCULBg4Online_B1);
    setlabelstates(ui->StopBRKMP2lbl,!this->database->BR2CT_MP2Bg2ParkingBrkRlsed_B1,this->database->CTHM_BCURBg4Online_B1);
    setlabelstates(ui->StopBRKM1lbl,!this->database->BR1CT_M1Bg2ParkingBrkRlsed_B1,this->database->CTHM_BCULBg6Online_B1);
    setlabelstates(ui->StopBRKM2lbl,!this->database->BR2CT_M2Bg2ParkingBrkRlsed_B1,this->database->CTHM_BCURBg6Online_B1);
    ...
    setonlinestates(ui->GTC1_1lbl,this->database->CTHM_BCULBg1Online_B1);
    setonlinestates(ui->STC1_2lbl,this->database->CTHM_BCULBg2Online_B1);
    setonlinestates(ui->SMP1_1lbl,this->database->CTHM_BCULBg3Online_B1);
    setonlinestates(ui->SMP1_2lbl,this->database->CTHM_BCULBg4Online_B1);
    setonlinestates(ui->SM1_1lbl,this->database->CTHM_BCULBg5Online_B1);
    setonlinestates(ui->GM1_2lbl,this->database->CTHM_BCULBg6Online_B1);

    setonlinestates(ui->GTC2_1lbl,this->database->CTHM_BCURBg1Online_B1);
    setonlinestates(ui->STC2_2lbl,this->database->CTHM_BCURBg2Online_B1);
    setonlinestates(ui->SMP2_1lbl,this->database->CTHM_BCURBg3Online_B1);
    setonlinestates(ui->SMP2_2lbl,this->database->CTHM_BCURBg4Online_B1);
    setonlinestates(ui->SM2_1lbl,this->database->CTHM_BCURBg5Online_B1);
    setonlinestates(ui->GM2_2lbl,this->database->CTHM_BCURBg6Online_B1);
